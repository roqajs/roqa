...
var $tmpl_1 = template("<label><input type=\"number\" min=\"0\" max=\"10\"><input type=\"range\" min=\"0\" max=\"10\"></label><label><input type=\"number\" min=\"0\" max=\"10\"><input type=\"range\" min=\"0\" max=\"10\"></label><p> </p>");
function SliderMath() {
	const a = {
		v: 1,
		e: []
