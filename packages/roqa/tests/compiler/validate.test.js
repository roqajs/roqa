...
/**
 * Tests for the AST validation phase of the Roqa compiler
 *
 * The validate transform runs in Phase 2 of the compilation pipeline and enforces
 * Roqa's component model constraints. It ensures that only valid JSX patterns are
 * used:
 ...
 *
 * PascalCase components (like React's <MyComponent>) are rejected because Roqa
