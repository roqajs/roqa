...
/**
 * Generate the bind() call code
 * @param {ProcessedBinding} binding
 * @param {string} expressionCode - The expression code (with get() replaced by v if needed)
 * @returns {string}
 */
...
/**
 * Check if an expression contains any get() calls
